...
const CropEasy = ({ photo, setOpenCrop }) => {
  ...
  const handleCropComplate = (cropedArea, cropedAreaPixels) => {
  ...
  return (
    <div className="fixed z-[1000] inset-0 bg-black/50 flex justify-center p-5 overflow-auto">
      <div className="bg-white h-fit w-full sm:max-w-[350px] p-4 rounded-lg">
        ...
        <div className="flex justify-between gap-2 flex-wrap">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-lg text-white border bg-blue-500 text-sm disabled:opacity-70"
          >
            Crop & Upload
          </button>
        </div>
